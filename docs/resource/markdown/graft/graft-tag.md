 ...
 */
$.event(type :string, listener :(ev :Event) =>any) :void;
...
/** vo 객체의 HTML 반환 */
$.getHtmls() :{[string] :string};
/** vo 객체의 HTML 세팅 */
$.setHtmls(vl :{[string] :string}) :void;

/** vo 객체의 TEXT 반환 */
$.getTexts() :{[string] :string};
/** vo 객체의 TEXT 세팅 */
$.setTexts(vl :{[string] :string}) :void;

/** vo 객체의 VALUE 반환 */
$.getValues() :{[string] :string};
/** vo 객체의 VALUE 세팅 */
$.setValues(vl :{[string] :string}) :void;
```
